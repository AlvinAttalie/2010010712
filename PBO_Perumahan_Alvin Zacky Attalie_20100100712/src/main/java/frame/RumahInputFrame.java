...
public class RumahInputFrame extends JFrame {
...
//            }
            ...
            try {
                if (this.id == 0) {
                    String cekSQL = "SELECT * FROM perumahan WHERE nama = ?";
                    ...
                    String insertSQL = "INSERT INTO perumahan SET nama = ?, id_merk = ?, id_class = ?";
                    ...
                    String cekSQL = "SELECT * FROM perumahan WHERE nama=? AND id!=?";
                    ps = c.prepareStatement(cekSQL);
                    ps.setString(1, nama);
                    ps.setInt(2, id);
                    ResultSet rs = ps.executeQuery();
                    ...
                    String updateSQL = "UPDATE perumahan SET nama=?, id_class=?, id_merk=? WHERE id=?";
    ...
    public void isiKomponen() {
        ...
        String findSQL = "SELECT * FROM perumahan WHERE id = ?";
    ...
    public void classcb() {
        Connection c = Koneksi.getConnection();
        String selectSQL = "SELECT * FROM class ORDER by jenis_perumahan";
